//insert last function(with testing ,by calling function dispaly and count)
#include<stdio.h>
#include<stdlib.h>
...
{
  PNODE newn = NULL; //Allocate Memory For Node
  newn = (PNODE)malloc(sizeof(NODE));//Initialze node
